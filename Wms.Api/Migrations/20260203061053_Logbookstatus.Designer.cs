...
namespace Wms.Api.Migrations
{
    ...
    [Migration("20260203061053_Logbookstatus")]
    partial class Logbookstatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wms.Api.Entities.InvoiceItem", b =>
                {
                    ...
                    b.Property<decimal>("WarrantyDurationMonths")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Wms.Api.Entities.LogbookEntry", b =>
                {
                    ...
                    b.Property<Guid>("LogbookStatusId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Wms.Api.Entities.LogbookEntry", b =>
                {
                    b.HasOne("Wms.Api.Entities.Lookup", "LogbookStatus")
                        .WithMany()
                        .HasForeignKey("LogbookStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
