...
const CartonSizeCreateEdit = (props: {
  formik: FormikProps<YupCartonSizeCreateEdit>;
}) => {
  ...
  return (
    <DataList
      ...
      data={[
        {
          label: t("name"),
          required: isRequiredField(CartonSizeCreateEditSchema, "name"),
          value: (
            <TextField
              fullWidth
              id="name"
...
export default CartonSizeCreateEdit;
