...
export interface NotificationWithDownloadDialogProps {
  open: boolean;
  title: string;
  titleKey?: string;
  titleArgs?: string[];
...
export const NotificationWithDownloadDialog = (
  props: NotificationWithDownloadDialogProps
) => {
  ...
  return (
    <Dialog onClose={props.onClose} open={props.open} fullWidth>
      ...
      <DialogActions>
        <Button onClick={props.onDownload}>{t("common:download")}</Button>
