...
interface DelayedNumberInputProps extends StandardTextFieldProps {
  delay: number;
  onTypingStarted?: () => void;
}
const DelayedNumberInput: React.FC<DelayedNumberInputProps> = (props) => {
...
export default DelayedNumberInput;
